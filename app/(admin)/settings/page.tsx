              ...
              <Col xs={24} sm={8}>
                <Card size="small" style={{ background: '#f6ffed', borderColor: '#b7eb8f' }}>
                  <Space direction="vertical">
                    ...
                    <Badge status="success" text={process.env.NEXT_PUBLIC_API_URL ? "Online (Cloud)" : "Online (Port 4000)"} />
                  </Space>
                </Card>
              </Col>
              <Col xs={24} sm={8}>
                <Card size="small" style={{ background: '#e6f7ff', borderColor: '#91d5ff' }}>
                  <Space direction="vertical">
                    ...
                    <Badge status="processing" text={typeof window !== 'undefined' && window.location.hostname !== 'localhost' ? "Active (Cloud)" : "Active (Port 3000)"} />
                  </Space>
                </Card>
              </Col>
            </Row>
          ...
          >
            <Form layout="vertical">
              ...
              <Form.Item label="DotStat Engine URL endpoint">
                <Input defaultValue={process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000/api/v1"} style={{ maxWidth: 480 }} />
              </Form.Item>
