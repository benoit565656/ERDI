...
import { Row, Col, Card, Statistic, Table, List, Button, Space, Typography, Tag, Spin } from 'antd';
  ...
  if (isLoading) {
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '60vh' }}>
        <Spin size="large" tip="Loading administrative dashboard..." />
      </div>
    );
  }
          ...
          >
            <List
              ...
              renderItem={(item: any) => (
                <List.Item>
                  <List.Item.Meta
                    title={<Text strong>{item.action.replace('_', ' ')}</Text>}
                    description={
